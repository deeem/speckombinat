...
function speckombinat_scripts() {
	...
	wp_enqueue_style( 'speckombinat-fonts', '//fonts.googleapis.com/css?family=Roboto+Slab:400,100,300,700|Open+Sans:400,300,700&subset=latin,cyrillic', array('bootstrap'));
	...
	if ( is_page_template( 'page-home.php') ) {
		wp_enqueue_script( 'yandex-map' , 'https://api-maps.yandex.ru/2.1/?lang=ru_RU', '', false, true );
		wp_enqueue_script( 'home-contact', get_template_directory_uri() . '/template-parts/home-contact.js', array('jquery', 'yandex-map'), false, true );
	}
}
